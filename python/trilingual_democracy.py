link = 'https://www.codewars.com/kata/62f17be8356b63006a9899dc/train/python'
...
def trilingual_democracy(group):
    ...
    if len(set(array)) == 1:
        ...
        return next(c for c in array if array.count(c) == 1)
    else:
        return next(l for l in official_languages if array.count(l) == 0)
